...
pub struct SupervisorManager {
    ...
    active_supervisors: Arc<Mutex<HashMap<String, Arc<tokio::sync::Mutex<WorkerSupervisor>>>>>,
}
...
impl SupervisorManager {
    ...
    pub async fn spawn_worker(
        ...
        let temp_dir = tempdir().map_err(SupervisorError::SpawnFailed)?;
        ...
        let supervisor_arc = Arc::new(tokio::sync::Mutex::new(supervisor));
        {
            ...
            active.insert(run_id.to_string(), Arc::clone(&supervisor_arc));
        }
