...
| ADR                                                                                  | Decision                                                                  | Status   |
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- | -------- |
| [ADR-0005 Option Pricing Models](../DECISIONS/0005-option-pricing-models.md)         | European Black-Scholes only; American and exotic models deferred          | Accepted |
...
| [Decision Records](../DECISIONS/0005-option-pricing-models.md) | Approved pricing models, providers, and Artifact isolation | Accepted 2026-08-17                                                          |
