...
use domain::research::{
    ...
    ReportType, ResearchDocument, ResearchNote, ResearchProject, ResearchReport,
...
pub async fn get_research_project(
    id: String,
    state: State<'_, AppState>,
) -> Result<Option<ResearchProject>, AppError> {
...
pub async fn get_research_document(
    id: String,
    state: State<'_, AppState>,
) -> Result<Option<ResearchDocument>, AppError> {
...
pub async fn get_research_report(
    id: String,
    state: State<'_, AppState>,
) -> Result<Option<ResearchReport>, AppError> {
