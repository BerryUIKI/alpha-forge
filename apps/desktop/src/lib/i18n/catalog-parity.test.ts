...
describe("Catalog parity", () => {
  ...
  it("workspace catalog has parity between en and zh-CN", () => {
    const result = assertCatalogParity(
      enCatalog.workspace as Record<string, unknown>,
      zhCNCatalog.workspace as Record<string, unknown>,
      "workspace",
    );
    expect(result.hasParity).toBe(true);
    expect(result.missingInZhCN).toHaveLength(0);
  ...
  it("research catalog has parity between en and zh-CN", () => {
    const result = assertCatalogParity(
      enCatalog.research as Record<string, unknown>,
      zhCNCatalog.research as Record<string, unknown>,
      "research",
    );
    expect(result.hasParity).toBe(true);
    expect(result.missingInZhCN).toHaveLength(0);
  ...
  it("journal catalog has parity between en and zh-CN", () => {
    const result = assertCatalogParity(
      enCatalog.journal as Record<string, unknown>,
      zhCNCatalog.journal as Record<string, unknown>,
      "journal",
    );
    expect(result.hasParity).toBe(true);
    expect(result.missingInZhCN).toHaveLength(0);
  ...
  it("artifacts catalog has parity between en and zh-CN", () => {
    const result = assertCatalogParity(
      enCatalog.artifacts as Record<string, unknown>,
      zhCNCatalog.artifacts as Record<string, unknown>,
      "artifacts",
    );
    expect(result.hasParity).toBe(true);
    expect(result.missingInZhCN).toHaveLength(0);
  ...
  it("agent catalog has parity between en and zh-CN", () => {
    const result = assertCatalogParity(
      enCatalog.agent as Record<string, unknown>,
      zhCNCatalog.agent as Record<string, unknown>,
      "agent",
    );
    expect(result.hasParity).toBe(true);
    expect(result.missingInZhCN).toHaveLength(0);
